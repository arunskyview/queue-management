...
use App\Http\Controllers\CounterAllotmentController;
...
Route::middleware(['setLocale'])->group(function () {
    Route::middleware(['auth'])->group(function () {
        ...
        Route::resource('allotment',CounterAllotmentController::class)->middleware('permission:view allot counters');
