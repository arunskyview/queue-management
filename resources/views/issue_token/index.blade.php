                ...
                <div class="row">
                    <div class="col s12">
                        <div class="card" style="background:#f9f9f9;box-shadow:none" id="service-btn-container">
                            ...
                            <span class="btn btn-large btn-queue waves-effect waves-light mb-1" id="service_id_24" style="background: #009688; font-size:37px;padding:80px;" onclick="queueDept({{$service}})">{{$service->name}}</span>
                            @endforeach
                        </div>
                    </div>
                    ...
                    <div class="card-content">
                        <div class="row">
                            <div class="input-field col s4" id="name_tab">
                                ...
                                <label for="name">{{__('messages.settings.iqama_number')}}</label>
                                <div class="name">
