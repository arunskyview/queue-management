                            ...
                            <form id="service_form" method="post" action="{{route('services.store')}}">
                                ...
                                <div class="row">
                                    <div class="row form_align">
                                        ...
                                        <div class="input-field col s6">
                                            <label for="name_ar">{{__('messages.service_page.add service arabic')}}</label>
                                            <input id="name_ar" name="name_ar" type="text" value="{{old('name_ar')}}" data-error=".name_ar">
                                            <div class="name_ar">
                                    ...
                                    <div class="row form_align">
                                        ...
                                        <div class="input-field col s3">
                                            ...
                                            <input id="number_of_token" name="number_of_token" type="number" value="{{old('number_of_token')}}" data-error=".number_of_token">
...
<script>
    ...
    function enableRequired() {
        ...
        // iqama
        if ($('#ask_iqama_number').val() == 1) {
            $('#iqama_number_required').prop('disabled', false);
        } else {
            $('#iqama_number_required').val(0);
            $('#iqama_number_required').prop('disabled', true);
        }
        // end iqama
        if ($('#ask_phone').val() == 1) {
