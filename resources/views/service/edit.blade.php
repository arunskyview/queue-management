                            ...
                            <form id="service_form" method="post" action="{{route('services.update',[$service->id])}}">
                                ...
                                <div class="row">
                                    <div class="row form_align">
                                        ...
                                        <div class="input-field col s6">
                                            <label for="name_ar">{{__('messages.service_page.service name arabic')}}</label>
                                            <input id="name_ar" name="name_ar" type="text" value="{{$service->name_ar}}" data-error=".name_ar">
                                            <div class="name_ar">
                                                @if ($errors->has('name_ar'))
                                                <span class="text-danger errbk">{{ $errors->first('name_ar') }}</span>
                                                @endif
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row form_align">
                                        ...
                                        <div class="input-field col s3">
                                            <label for="number_of_token">{{__('messages.service_page.number of token')}}</label>
                                            <input id="number_of_token" name="number_of_token" type="number" value="{{$service->number_of_token}}" data-error=".number_of_token">
                                            <div class="number_of_token">
                                                @if ($errors->has('number_of_token'))
                                                <span class="text-danger errbk">{{ $errors->first('number_of_token') }}</span>
                                                @endif
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row form_align">
                                        <div class="input-field col s3">
                                            ...
                                            <label>{{__('messages.service_page.Ask Iqama Number For Token')}}</label>
                                            <div class="ask_name">
                                        ...
                                        <div class="input-field col s3">
                                            ...
                                            <label>{{__('messages.service_page.Iqama Number is required')}}</label>
                                    ...
                                    <div class="row form_align">
                                        ...
                                        {{-- Iqama --}}
                                        {{-- <div class="input-field col s3">
                                            <select name="ask_iqama_number" id="ask_iqama_number" data-error=".ask_iqama_number" onchange="enableRequired()">
                                                <option value="0" @if($service->ask_iqama_number==0) selected @endif>No</option>
                                                <option value="1" @if($service->ask_iqama_number==1) selected @endif>Yes</option>
                                            </select>
                                            <label>{{__('messages.service_page.Ask Iqama Number For Token')}}</label>
                                            <div class="ask_iqama_number">
                                                @if ($errors->has('ask_iqama_number'))
                                                <span class="text-danger errbk">{{ $errors->first('ask_iqama_number') }}</span>
                                                @endif
                                            </div>
                                        </div>
                                        <div class="input-field col s3">
                                            <select name="iqama_number_required" id="iqama_number_required" data-error=".iqama_number_required">
                                                <option value="0" @if($service->iqama_number_required==0) selected @endif>No</option>
                                                <option value="1" @if($service->iqama_number_required==1) selected @endif>Yes</option>
                                            </select>
                                            <label>{{__('messages.service_page.Iqama Number is required')}}</label>
                                            <div class="iqama_number_required">
                                                @if ($errors->has('iqama_number_required'))
                                                <span class="text-danger errbk">{{ $errors->first('iqama_number_required') }}</span>
                                                @endif
                                            </div>
                                        </div> --}}
                                        {{-- End iqama --}}
