<aside class="sidenav-main nav-expanded nav-lock nav-collapsible sidenav-light sidenav-active-rounded">
  <div class="brand-sidebar">
    <h1 class="logo-wrapper">
      <a class="brand-logo darken-1" style="top: 0px; left: 0px;padding:10px;">
        {{-- <span class="logo-text hide-on-med-and-down" style="color: #fff; font-weight:bold">Q M</span> --}}
        <div class="col s6 ">
            <img width="80" style="height: 45px;width: auto;" src="{{asset('storage/app/public/logos/logo.png')}}" alt="">
        </div>
        </a>
  ...
  <ul class="sidenav sidenav-collapsible leftside-navigation collapsible sidenav-fixed menu-shadow" style="padding-top: 20px; padding-left:0" id="slide-out" data-menu="menu-navigation" data-collapsible="accordion">
    ...
    @endcan
    @can('view allot counters')
    <li class="bold"><a class="waves-effect waves-cyan @yield('allot_counter') " href="{{route('allotment.index')}}"><i class="material-icons">dvr</i><span class="menu-title" data-i18n="Kanban">{{__('messages.menu.allot counters')}}</span></a>
    </li>
    @endcan
    @can('view reports')
