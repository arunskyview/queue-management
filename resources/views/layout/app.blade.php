...
<head>
    ...
    <title>QM Solution | @yield('title')</title>
...
<body class="vertical-layout page-header-light vertical-menu-collapsible vertical-dark-menu preload-transitions 2-columns noprint ">
        ...
        <div class="navbar navbar-fixed">
            <nav class="navbar-main navbar-color nav-collapsible sideNav-lock">
                <div class="nav-wrapper">
                    <ul class="navbar-list left" style="padding-left: 210px;">
                        <li><span style="font-weight: bold; font-size: x-large; ">QM Solution</span></li>
                    </ul>
    ...
    <footer class="page-footer footer footer-static navbar-border navbar-shadow">
        ...
        <div class="container">
            <span>Powered by&nbsp;<a href="https://skyviewads.com/" target="_blank" style="color:#ffffff;font-weight: bolder;">Skyview Smart Solution</a>&nbsp;All rights reserved</span>
            @if(\App::currentLocale() == 'sa')
