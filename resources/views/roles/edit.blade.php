                                        ...
                                        <div class="input-field col s12">
                                            <table id="page-length-option" class="display dataTable">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td>{{__('messages.user_roles_page.view allot counters')}}</td>
                                                        <td>
                                                            <label>
                                                                <input type="checkbox" class="checkbox" id="allot_counters" name="permission[view allot counters]" {{ in_array('view allot counters', $permissions)?'checked':''}}/>
                                                                <span></span>
                                                            </label>
                                                        </td>
                                                    </tr>
